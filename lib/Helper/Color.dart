...
extension colors on ColorScheme {
  ...
  static const Color primary = /*Color(0xff64EDFF);*/Color(0xffFC6A57);
  static const Color secondary = /*Color(0xffd5f0f6);*/Color(0xffFDC994);

  Color get btnColor => brightness == Brightness.dark ? whiteTemp : primary;

  Color get changeablePrimary => brightness == Brightness.dark
      ? const /*Color(0xffd5f0f6)*/Color(0xffFDC994)
      : const /*Color(0xff64EDFF);*/Color(0xffFC6A57);
  ...
  static const Color grad1Color = /*Color(0xffd5f0f6);*/Color(0xffFFBD69);
  static const Color grad2Color = /*Color(0xff64EDFF);*/Color(0xffFF6363);
